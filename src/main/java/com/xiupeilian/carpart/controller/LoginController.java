...
import com.xiupeilian.carpart.util.SendSms;
...
import static com.xiupeilian.carpart.constant.SysConstant.ACCESS_KEY_ID;
import static com.xiupeilian.carpart.constant.SysConstant.ACCESS_KEY_SECRET;
...
public class LoginController {
    ...
    public void sms(String phone){
        ...
        request.putQueryParameter("SignName", "\u6e05\u97f5");
        request.putQueryParameter("TemplateCode", "SMS_172883752");
    ...
    public void getPassword(HttpServletResponse response,LoginVo vo) throws IOException {
       //查询sys_user,看看邮箱以及账号是否匹配
        ...
        if(null==user){
            ...
            message.setFrom("15893012109@163.com");
            message.setTo(user.getEmail());
            message.setSubject("我是清韵，这是我的测试demo:");
