...
public class AliyunOSSClientUtil {
    ...
    public static String uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {
        ...
        System.out.println("uploadObject2OSS"+file.getName());
        try {
            //以输入流的形式上传文件
    ...
    public static void main(String[] args) {
        ...
        //上传文件
        String files = "C:\\Users\\sunflower\\Pictures\\Saved Pictures\\timg.png,"
                + "C:\\Users\\sunflower\\Pictures\\Saved Pictures\\224931-154557657177fa.jpg";
