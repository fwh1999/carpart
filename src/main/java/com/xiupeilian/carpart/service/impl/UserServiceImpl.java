...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public List<SysUser> findUserByCompanyId(Integer companyId) {
        return userMapper.findUserByCompanyId(companyId);
    }

    @Override
    public List<SysUser> findUserByCompanyIdAndUserName(StaffVo vo) {
        return userMapper.findUserByCompanyIdAndUserName(vo);
    }
